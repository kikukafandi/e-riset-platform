        ...
        <div class="max-w-4xl mx-auto">
            ...
            <div class="bg-white rounded-lg shadow-lg border border-slate-200 overflow-hidden">
                ...
                <div class="bg-slate-100">
                    <div class="flex">
                        <button type="button" onclick="switchTab('mahasiswa')" id="tab-mahasiswa" class="tab-button active flex-1 flex items-center justify-center gap-2">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                            </svg>
                            <span>Mahasiswa</span>
                        </button>
                        <button type="button" onclick="switchTab('nonmahasiswa')" id="tab-nonmahasiswa" class="tab-button flex-1 flex items-center justify-center gap-2">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div class="px-8 py-3 bg-white">
                        <p class="text-sm text-slate-600 text-center">
                            <span class="font-semibold text-navy">Pilih kategori pemohon</span> yang sesuai dengan status Anda
                        </p>
                    </div>
                </div>
                ...
                <div class="px-8 py-8">
                    ...
                    <div id="content-mahasiswa" class="tab-content">
                        <form action="{{ route('register') }}" method="post" class="space-y-6">
                            ...
                            <!-- Data Akun -->
                            <div>
                                <h3 class="text-lg font-semibold text-navy mb-4 pb-2 border-b border-slate-200">Data Akun</h3>
                                <div class="grid md:grid-cols-2 gap-5">
                                    ...
                                    <div>
                                        <label class="block text-sm font-semibold text-slate-700 mb-2">Nomor Telepon <span class="text-red-600">*</span></label>
                                        ...
                                        @error('no_telepon') <p class="text-xs text-red-600 mt-1">{{ $message }}</p> @enderror
                                    </div>
                                    <div>
                                        <label class="block text-sm font-semibold text-slate-700 mb-2">Password <span class="text-red-600">*</span></label>
                                        <input type="password" name="password" required
                                            class="w-full rounded-lg border border-slate-300 px-4 py-2.5 text-slate-900 placeholder-slate-400 focus:border-navy focus:outline-none focus:ring-2 focus:ring-navy/20 @error('password') border-red-500 @enderror"
                            ...
                            <!-- Data Pemohon -->
                            <div>
                                <h3 class="text-lg font-semibold text-navy mb-4 pb-2 border-b border-slate-200">Data Pemohon</h3>
                                <div class="space-y-4">
                                    <div>
                                    ...
                                    <div class="grid md:grid-cols-2 gap-5">
                                        <div>
                                            <label class="block text-sm font-semibold text-slate-700 mb-2">Nomor NIK <span class="text-red-600">*</span></label>
                                        ...
                                        <div>
                                            <label class="block text-sm font-semibold text-slate-700 mb-2">NIM <span class="text-red-600">*</span></label>
                                    ...
                                    <div>
                                        <label class="block text-sm font-semibold text-slate-700 mb-2">Alamat <span class="text-red-600">*</span></label>
                                    ...
                                    <div class="grid md:grid-cols-2 gap-5">
                                        <div>
                                            <label class="block text-sm font-semibold text-slate-700 mb-2">Universitas <span class="text-red-600">*</span></label>
                                            ...
                                            @error('kampus') <p class="text-xs text-red-600 mt-1">{{ $message }}</p> @enderror
                                        </div>
                                        <div>
                                            <label class="block text-sm font-semibold text-slate-700 mb-2">Jenjang Pendidikan <span class="text-red-600">*</span></label>
                                    ...
                                    <div>
                                        <label class="block text-sm font-semibold text-slate-700 mb-2">Jurusan <span class="text-red-600">*</span></label>
                                        ...
                                        @error('jurusan') <p class="text-xs text-red-600 mt-1">{{ $message }}</p> @enderror
                                    </div>
                                </div>
                            </div>
                        ...
                        <form action="{{ route('register') }}" method="post" class="space-y-6">
                            ...
                            <div>
                                ...
                                <div class="space-y-4">
                                    ...
                                    <div>
                                        <label class="block text-sm font-semibold text-slate-700 mb-2">NIP (maks 18 digit)</label>
                                        <input type="text" name="npwp" value="{{ old('npwp') }}" inputmode="numeric" pattern="^[0-9]{1,18}$" maxlength="18"
                                        ...
                                        @error('npwp') <p class="text-xs text-red-600 mt-1">{{ $message }}</p> @enderror
                                    </div>
                                    <div>
                                        <label class="block text-sm font-semibold text-slate-700 mb-2">Alamat <span class="text-red-600">*</span></label>
                                        <textarea name="alamat" rows="3" required
                                    ...
                                    <div class="grid md:grid-cols-2 gap-5">
                                        <div>
                                            <label class="block text-sm font-semibold text-slate-700 mb-2">Instansi <span class="text-red-600">*</span></label>
                                        ...
                                        <div>
                                            <label class="block text-sm font-semibold text-slate-700 mb-2">Sponsor Riset</label>
                                            <input type="text" name="sponsor_riset" value="{{ old('sponsor_riset') }}"
                                            ...
                                            @error('sponsor_riset') <p class="text-xs text-red-600 mt-1">{{ $message }}</p> @enderror
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="px-8 py-4 border-t border-slate-200 bg-slate-50 text-center">
                    <p class="text-sm text-slate-600">
                        Sudah memiliki akun? 
                        <a href="{{ route('loginPage') }}" class="font-semibold text-navy hover:text-gold transition-colors">Login di sini</a>
                    </p>
                </div>
            </div>
